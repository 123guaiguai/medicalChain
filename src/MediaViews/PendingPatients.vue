<template>
  <div class="pendingPatientContainer">
    <el-text class="title" type="primary" size="large">待诊患者列表</el-text>
    ...
    <div class="emitWrapper">
      ...
      <el-tag class="ml-2" type="success" size="large">
        <div class="tag-center" @click="addRecord">
          <el-icon><Bell /></el-icon>问诊
        </div>
      </el-tag>
    </div>
  </div>
...
//跳转到添加病历页面
const addRecord = () => {
  router.push("/mediaHome/addMedicalRecord");
};
</script>

<style scoped lang="less">
.pendingPatientContainer {
  width: 80%;
