<template>
  <div class="statisticContainer">
    ...
    <div class="chartWrapper">
      <el-text class="title" type="primary" size="large">日申请报销保单量</el-text>
      <el-divider border-style="dashed" />
    ...
    <div class="chartWrapper">
      <el-text class="title" type="primary" size="large">购买保险种类统计</el-text>
      <el-divider border-style="dashed" />
    ...
    series: [
      {
        ...
        data: [300, 200, 250, 300, 250, 180,280], // 折线图数据
        markLine: {
          // 标记线，用于显示平均值
          data: [
            {
